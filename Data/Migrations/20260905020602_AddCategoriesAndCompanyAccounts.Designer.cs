...
namespace handytool_api.Data.Migrations
{
    ...
    [Migration("20260905020602_AddCategoriesAndCompanyAccounts")]
    partial class AddCategoriesAndCompanyAccounts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("handytool_api.Models.UserAccount", b =>
                {
                    ...
                    b.ToTable("UserAccounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserAccounts_CompanyMembership", "(\"CompanyId\" IS NULL AND \"CompanyRole\" IS NULL AND \"AccountTypeCode\" IS NOT NULL) OR (\"CompanyId\" IS NOT NULL AND \"CompanyRole\" IS NOT NULL AND \"CompanyRole\" IN ('Admin', 'Member') AND \"AccountTypeCode\" IS NULL)");
                        });
                });
